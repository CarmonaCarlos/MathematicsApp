    ...
    comprobar.innerHTML = "¡Hay elementos faltantes!"
          ...
          if((txt1.value== "" || txt1.value== null)||(txt2.value== "" || txt2.value== null)||(txt3.value== "" || txt3.value== null)||(txt4.value== "" || txt4.value== null)||(txt5.value== "" || txt5.value== null)||(txt6.value== "" || txt6.value== null)||(txt7.value== "" || txt7.value== null)||(txt8.value== "" || txt8.value== null)||(txt9.value== "" || txt9.value== null)||(txt10.value== "" || txt10.value== null)||(txt11.value== "" || txt11.value== null)||(txt12.value== "" || txt12.value== null)||(txt13.value== "" || txt13.value== null)||(txt14.value== "" || txt14.value== null)||(txt15.value== "" || txt15.value== null)||(txt16.value== "" || txt16.value== null)||(txt17.value== "" || txt17.value== null)||(txt18.value== "" || txt18.value== null)||(txt19.value== "" || txt19.value== null)||(txt20.value== "" || txt20.value== null)) {
            ...
            t(txt20);
              ...
              var t4=document.form1.termino4.value;
              ...
              var res=(a+b+c+d);
              function a (n1,n2,n3,n4,n5,n6,n7,n8,n9,n10,n11,n12,n13,n14,n15,n16,t1,t2,t3,t4,res){
                var n1=t1;  
                var n5=t2;
                var n9=t3;
                var n13=t4;
                var a1=((n6*n11*n16)+(n7*n12*n14)+(n10*n15*n8)+(n8*n11*n14*-1)+(n15*n12*n6*-1)+(n10*n7*n16*-1))*(n1);
                var b1=((n5*n11*n16)+(n7*n12*n13)+(n9*n15*n8)+(n8*n11*n13*-1)+(n15*n12*n5*-1)+(n9*n7*n16*-1))*(n2*-1);
                var c1=((n5*n10*n16)+(n6*n12*n13)+(n9*n14*n8)+(n8*n10*n13*-1)+(n14*n12*n5*-1)+(n9*n6*n16*-1))*(n3);
                var d1=((n5*n10*n15)+(n6*n11*n13)+(n9*n14*n7)+(n7*n10*n13*-1)+(n14*n11*n5*-1)+(n9*n6*n15*-1))*(n4*-1);
                var res1=(a1+b1+c1+d1);
                var x = res1/res;
                return x;
              }
              var X= a(n1,n2,n3,n4,n5,n6,n7,n8,n9,n10,n11,n12,n13,n14,n15,n16,t1,t2,t3,t4,res);
              function b (n1,n2,n3,n4,n5,n6,n7,n8,n9,n10,n11,n12,n13,n14,n15,n16,t1,t2,t3,t4,res){
                var n2=t1;
                var n6=t2;
                var n10=t3;
                var n14=t4;
                var a2=((n6*n11*n16)+(n7*n12*n14)+(n10*n15*n8)+(n8*n11*n14*-1)+(n15*n12*n6*-1)+(n10*n7*n16*-1))*(n1);
                var b2=((n5*n11*n16)+(n7*n12*n13)+(n9*n15*n8)+(n8*n11*n13*-1)+(n15*n12*n5*-1)+(n9*n7*n16*-1))*(n2*-1);
                var c2=((n5*n10*n16)+(n6*n12*n13)+(n9*n14*n8)+(n8*n10*n13*-1)+(n14*n12*n5*-1)+(n9*n6*n16*-1))*(n3);
                var d2=((n5*n10*n15)+(n6*n11*n13)+(n9*n14*n7)+(n7*n10*n13*-1)+(n14*n11*n5*-1)+(n9*n6*n15*-1))*(n4*-1);
                var res2=(a2+b2+c2+d2);
                var y = res2/res;
                return y;
              }
              var Y= b(n1,n2,n3,n4,n5,n6,n7,n8,n9,n10,n11,n12,n13,n14,n15,n16,t1,t2,t3,t4,res);
              function c (n1,n2,n3,n4,n5,n6,n7,n8,n9,n10,n11,n12,n13,n14,n15,n16,t1,t2,t3,t4,res){
                var n3=t1;
                var n7=t2;
                var n11=t3;
                var n15=t4;
                var a3=((n6*n11*n16)+(n7*n12*n14)+(n10*n15*n8)+(n8*n11*n14*-1)+(n15*n12*n6*-1)+(n10*n7*n16*-1))*(n1);
                var b3=((n5*n11*n16)+(n7*n12*n13)+(n9*n15*n8)+(n8*n11*n13*-1)+(n15*n12*n5*-1)+(n9*n7*n16*-1))*(n2*-1);
                var c3=((n5*n10*n16)+(n6*n12*n13)+(n9*n14*n8)+(n8*n10*n13*-1)+(n14*n12*n5*-1)+(n9*n6*n16*-1))*(n3);
                var d3=((n5*n10*n15)+(n6*n11*n13)+(n9*n14*n7)+(n7*n10*n13*-1)+(n14*n11*n5*-1)+(n9*n6*n15*-1))*(n4*-1);
                var res3=(a3+b3+c3+d3);
                var z = res3/res;
                return z;
              }
              var Z= c(n1,n2,n3,n4,n5,n6,n7,n8,n9,n10,n11,n12,n13,n14,n15,n16,t1,t2,t3,t4,res);
              function d (n1,n2,n3,n4,n5,n6,n7,n8,n9,n10,n11,n12,n13,n14,n15,n16,t1,t2,t3,t4,res){
                var n4=t1;
                var n8=t2;
                var n12=t3;
                var n16=t4;
                var a4=((n6*n11*n16)+(n7*n12*n14)+(n10*n15*n8)+(n8*n11*n14*-1)+(n15*n12*n6*-1)+(n10*n7*n16*-1))*(n1);
                var b4=((n5*n11*n16)+(n7*n12*n13)+(n9*n15*n8)+(n8*n11*n13*-1)+(n15*n12*n5*-1)+(n9*n7*n16*-1))*(n2*-1);
                var c4=((n5*n10*n16)+(n6*n12*n13)+(n9*n14*n8)+(n8*n10*n13*-1)+(n14*n12*n5*-1)+(n9*n6*n16*-1))*(n3);
                var d4=((n5*n10*n15)+(n6*n11*n13)+(n9*n14*n7)+(n7*n10*n13*-1)+(n14*n11*n5*-1)+(n9*n6*n15*-1))*(n4*-1);
                var res4=(a4+b4+c4+d4);
                var t = res4/res;
                return t;
              }
              ...
              resultadoFinal.innerHTML = 'X = '+X.toFixed(3)+'<br/>'+'Y = '+Y.toFixed(3)+'<br/>'+'Z = '+ Z.toFixed(3)+'<br/>'+ 'W = '+ T.toFixed(3);
            }
          });
